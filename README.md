...
## 7. Improvements
Have to say this implementation was mainly for learning and testing purposes, there can be quite a lot of improvements, or better alternative strategies for this topic, for example examination of **focal loss** (strongly suggested for future work), BM25, reranking systems, even using community models, etc. any proper decisions at different levels could possibly significantly improve the performance of the system. This project was within a university setting, therefore further improvements have not yet been implemented although considered, may happen in the future. Having said that, this project may serve as a starting point for the relevant tasks.
