Original Paper can be found in <https://github.com/zyinghua/bert_for_climate_fever/blob/main/paper/A_BERT_based_model_for_Climate_Fact_Extraction_and_Claim_Verification.pdf>
